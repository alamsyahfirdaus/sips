...
<html lang="en">
    ...
    <body>
                ...
                <main>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg" style="margin-top: 80px;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="post" id="form">
                                            <div class="form-group">
                                                <input class="form-control py-4" id="email" name="email" type="text" placeholder="Email" autocomplete="off">
        ...
        <script src="<?= base_url(JS . 'password-recovery.js') ?>"></script>
    </body>
</html>